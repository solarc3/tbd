    ...
    <div v-if="pendientes.length" class="mb-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <div
          ...
          :key="task.id"
          class="p-4 border rounded-lg bg-red-50 shadow-sm hover:shadow-md transition"
        >
          <h2 class="text-lg font-semibold">{{ task.titulo }}</h2>
          <p class="text-sm text-gray-600">{{ task.descripcion }}</p>
          <p class="text-sm text-gray-500 mt-2">Vence: {{ task.fechaVencimiento }}</p>
    ...
    <div v-if="enProgreso.length" class="mb-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <div
            ...
            :key="task.id"
            class="p-4 border rounded-lg bg-blue-50 shadow-sm hover:shadow-md transition"
        >
          <h2 class="text-lg font-semibold">{{ task.titulo }}</h2>
          <p class="text-sm text-gray-600">{{ task.descripcion }}</p>
          <p class="text-sm text-gray-500 mt-2">Vence: {{ task.fechaVencimiento }}</p>
    ...
    <div v-if="completadas.length" class="mb-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <div
            ...
            :key="task.id"
            class="p-4 border rounded-lg bg-green-50 shadow-sm hover:shadow-md transition"
        >
          <h2 class="text-lg font-semibold">{{ task.titulo }}</h2>
          <p class="text-sm text-gray-600">{{ task.descripcion }}</p>
          <p class="text-sm text-gray-500 mt-2">Vence: {{ task.fechaVencimiento }}</p>
