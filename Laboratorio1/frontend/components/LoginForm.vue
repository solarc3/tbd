...
export const containerClass =
	"w-full min-h-screen flex items-center justify-center px-4 py-8 bg-gray-50";
</script>
				...
				<Card>
					<CardHeader>
						...
						<CardDescription
							...
							entrar a tu cuenta</CardDescription
						>
					</CardHeader>
					<CardContent>
						<form @submit.prevent="handleLogin" class="grid gap-4">
							<div
								v-if="error"
								class="p-3 rounded-md bg-red-50 text-red-600 text-sm"
							>
								{{ error }}
							</div>
