...
import Opiniones from '@/components/Opiniones.vue' // 🎯 ESTE IMPORT FALTABA
...
const placeOrder = async () => {
  ...
  try {
    const response = await pedidoService.completarPedido(order)
    ...
    opinionStore.mostrarOpinion(idPedido)
...
<template>
  ...
  <Opiniones
      v-if="opinionStore.showOpinionPopup && opinionStore.currentPedidoId"
      :id-pedido="opinionStore.currentPedidoId"
      @close="opinionStore.ocultarOpinion"
  />
</template>